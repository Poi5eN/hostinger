            ...
            <div className="flex flex-wrap -mx-4 lg:justify-between ">
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                  ...
                  <input type="text" placeholder="Your Name" name="name" class="border-[f0f0f0] w-full rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"/> 
                    ...
                    <ContactTextArea className="inputext"
                      row="6"
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full p-3 text-black transition border rounded border-primary bg-primary hover:bg-opacity-90 hover:bg-sky-500"
                  ...
                  <form onSubmit={handleSubmitCreate}>
                    ...
                    <div class="mb-6"><textarea rows="6" placeholder="Your Message" name="message" 
